...
import br.ufal.ic.p2.wepayu.Exceptions.Sindicato.TaxaSindicalNaoNumericaException;
import br.ufal.ic.p2.wepayu.Exceptions.Sindicato.TaxaSindicalNegativaException;
...
import br.ufal.ic.p2.wepayu.Repository.EmpregadosRepository;
...
public class SistemaEmpregados {
     ...
     * @param valor Novo valor do status.
    ...
    /**
     * Altera informações do método de pagamento.
     * @param empregado Empregado a ter as informações alteradas.
     * @param atributo Atributo a ser alterado.
     * @param valor Novo valor do atributo.
    ...
    /**
     * Altera informações do empregado.
     * @param empregado Empregado a ter as informações alteradas.
     * @param atributo  Atributo a ser alterado.
     * @param valor Novo valor do atributo.
     * @return Empregado com informações alteradas.
